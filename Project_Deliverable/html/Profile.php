...
{    
   //change Name if needed
    ...
    if(isset($_POST['email']))
    {
      ...
      $sql = "CALL GetMentor('$user_id')";
      $q = $conn->query($sql);
      $r = $q->fetch_assoc();
      $oldemail = trim($r['Email']);
      mysqli_free_result($q);
      mysqli_next_result($conn);

      if(!($newemail == $oldemail))//it has been changed so send verification email
      {
        echo "<b>newemail: ".$newemail."<br>oldemail: ".$oldemail."<br>strcmp:".substr_compare($newmail, $oldemail,0)."<br>";
        $EmailHash = md5( rand(0,1337) );
        $sql = "CALL CreateEmailChangeVerification('$newemail','$EmailHash','$oldemail');";
        $conn->query($sql);
        sendMentorEmailChangeRequest($newemail,$EmailHash,$oldemail);
        sendMentorEmailChangeNotice($oldemail,$newemail);
      }
    }
                        ...
                        <input type="hidden" id="oldemail" name="oldemail" value="<?php echo $email;?>"/>
		                    ...
		                    <?php 
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input id="firstname" name="firstname" value="<?php $printFname = str_replace("&apos", "'", $firstname); echo $printFname;?>" class="form-control here" type="text"disabled>
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="lastname" class="col-4 col-form-label">Last Name</label> 
                                <div class="col-8">
                                  <input id="lastname" name="lastname" value="<?php $printLname = str_replace("&apos", "'", $lastname); echo $printLname;?>" class="form-control here" type="text"disabled>
                                </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <textarea id="biography" name="biography" cols="40" rows="4" class="form-control" disabled><?php $printBio = str_replace("&apos", "'", $biography); echo $printBio;?></textarea>
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="publicinfo" class="col-4 col-form-label">Communication Methods</label> 
                                <div class="col-8">
                                  <textarea id="comDesc" name="comDesc" cols="40" rows="4" class="form-control" disabled><?php $printCom = str_replace("&apos", "'", $comDesc); echo $printCom;?></textarea>
                                </div>
                              </div>
                        				...
                        				<tbody>
                        					<?php 
                                                ...
                                                for($x = 0; $x < $num_skills_rows; $x++){
													...
													$skillsDesc = str_replace("&apos", "'", $skillsDesc);
                                                    $skillsName = $r['SkillName'];
													$skillsName = str_replace("&apos", "`", $skillsName);
                        				...
                        				<tbody>
                        					<?php 
                                                ...
                                                for($x = 0; $x < $num_education_rows; $x++){
													...
													$universityName = str_replace("&apos", "`", $universityName);
